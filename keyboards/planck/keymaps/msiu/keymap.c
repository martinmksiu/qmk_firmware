...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC__MUTE, KC_HYPR, KC_LALT, KC_LGUI, LOWER, SPC_FNC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, QWERTY,  DVORAK,  _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, _______, P_WORK,  P_VIMA,  _______, _______, _______,
